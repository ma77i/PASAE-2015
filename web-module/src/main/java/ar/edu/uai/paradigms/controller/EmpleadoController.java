...
public class EmpleadoController {
	...
	public @ResponseBody EmpleadoDTO createEmpleado(@RequestBody EmpleadoDTO empleadoDTO) {
		...
		return this.empleadoTranslator.translateToDTO(this.empleadoService
                .saveEspectador(this.empleadoTranslator.translate(empleadoDTO)));
	}

	@RequestMapping(method = RequestMethod.GET, value = "/{identifier}")
	public @ResponseBody EmpleadoDTO getEspectador(@PathVariable long identifier) {
		return this.empleadoTranslator.translateToDTO(this.empleadoService.retrieveEspectador(identifier));
	}
